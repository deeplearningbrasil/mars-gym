...
class AllModels(luigi.WrapperTask):
    ...
    def requires(self):
        ...
        for window_filter, _v in WINDOW_FILTER_DF.items():
          ...
          # Random
          yield EvaluateRandomIfoodModel(window_filter=window_filter, model_task_id=window_filter)

          # MostPopular
          yield EvaluateMostPopularIfoodModel(window_filter=window_filter, model_task_id=window_filter)
