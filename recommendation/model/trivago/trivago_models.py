...
class SimpleLinearModel(nn.Module):
    def __init__(self, n_users: int, n_items: int, n_factors: int, 
        ...
        self.device_embeddings      = nn.Embedding(4, 5)
        ...
        num_dense = 1 * n_factors + unit_features + context_embs * n_factors * window_hist_size #+ 2 + metadata_size
        ...
        # output
        self.output = nn.Linear(n_factors+ metadata_size, 1)
    ...
    def forward(self, user_ids, item_ids, price, pos_item_idx, platform_idx, device_idx,
                list_action_type_idx, list_clickout_item_idx, list_metadata):
...
#,
        ...
        x   = torch.cat((x, list_metadata.float()), dim=1)
