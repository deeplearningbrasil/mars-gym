...
gcloud ai-platform jobs submit training model_$(date +%Y%m%d_%H%M%S%sss) \
  ...
  -- \
  --module recommendation.task.model.trivago.trivago_models TrivagoLogisticModelInteraction --project trivago_contextual_bandit --data-frames-preparation-extra-params '{"filter_city": "Rio de Janeiro, Brazil"}' --n-factors 50 --learning-rate=0.001 --optimizer adam --metrics '["loss"]' --epochs 250 --obs-batch-size 200 --early-stopping-patience 10 --batch-size 200 --num-episodes 4 --output-model-dir "gs://deepfood-results-rio_janeiro_brazil" --bandit-policy model
...
gcloud ai-platform jobs submit training adaptive_$(date +%Y%m%d_%H%M%S%sss) \
  ...
  --scale-tier BASIC_GPU \
  -- \
  --module recommendation.task.model.trivago.trivago_models TrivagoLogisticModelInteraction --project trivago_contextual_bandit --data-frames-preparation-extra-params '{"filter_city": "Rio de Janeiro, Brazil"}' --n-factors 50 --learning-rate=0.001 --optimizer adam --metrics '["loss"]' --epochs 250 --obs-batch-size 200 --early-stopping-patience 10 --batch-size 200 --num-episodes 4 --output-model-dir "gs://deepfood-results-rio_janeiro_brazil" --bandit-policy adaptive --bandit-policy-params '{"exploration_threshold": 0.5, "decay_rate": 0.000199566512577}'  
...
gcloud ai-platform jobs submit training adaptive_$(date +%Y%m%d_%H%M%S%sss) \
  ...
  --scale-tier BASIC_GPU \
  -- \
  --module recommendation.task.model.trivago.trivago_models TrivagoLogisticModelInteraction --project trivago_contextual_bandit --data-frames-preparation-extra-params '{"filter_city": "Rio de Janeiro, Brazil"}' --n-factors 50 --learning-rate=0.001 --optimizer adam --metrics '["loss"]' --epochs 250 --obs-batch-size 200 --early-stopping-patience 10 --batch-size 200 --num-episodes 4 --output-model-dir "gs://deepfood-results-rio_janeiro_brazil" --bandit-policy adaptive --bandit-policy-params '{"exploration_threshold": 0.3, "decay_rate": 0.000199566512577}'  
...
gcloud ai-platform jobs submit training adaptive_$(date +%Y%m%d_%H%M%S%sss) \
  ...
  --scale-tier BASIC_GPU \
  -- \
  --module recommendation.task.model.trivago.trivago_models TrivagoLogisticModelInteraction --project trivago_contextual_bandit --data-frames-preparation-extra-params '{"filter_city": "Rio de Janeiro, Brazil"}' --n-factors 50 --learning-rate=0.001 --optimizer adam --metrics '["loss"]' --epochs 250 --obs-batch-size 200 --early-stopping-patience 10 --batch-size 200 --num-episodes 4 --output-model-dir "gs://deepfood-results-rio_janeiro_brazil" --bandit-policy adaptive --bandit-policy-params '{"exploration_threshold": 0.5, "decay_rate": 0.0000804686578455631}'  
...
gcloud ai-platform jobs submit training adaptive_$(date +%Y%m%d_%H%M%S%sss) \
  ...
  --scale-tier BASIC_GPU \
  -- \
  --module recommendation.task.model.trivago.trivago_models TrivagoLogisticModelInteraction --project trivago_contextual_bandit --data-frames-preparation-extra-params '{"filter_city": "Rio de Janeiro, Brazil"}' --n-factors 50 --learning-rate=0.001 --optimizer adam --metrics '["loss"]' --epochs 250 --obs-batch-size 200 --early-stopping-patience 10 --batch-size 200 --num-episodes 4 --output-model-dir "gs://deepfood-results-rio_janeiro_brazil" --bandit-policy adaptive --bandit-policy-params '{"exploration_threshold": 0.3, "decay_rate": 0.0000549291057748284}'  
...
gcloud ai-platform jobs submit training explore_then_exploit_$(date +%Y%m%d_%H%M%S%sss) \
  ...
  --scale-tier BASIC_GPU \
  -- \
  --module recommendation.task.model.trivago.trivago_models TrivagoLogisticModelInteraction --project trivago_contextual_bandit --data-frames-preparation-extra-params '{"filter_city": "Rio de Janeiro, Brazil"}' --n-factors 50 --learning-rate=0.001 --optimizer adam --metrics '["loss"]' --epochs 250 --obs-batch-size 200 --early-stopping-patience 10 --batch-size 200 --num-episodes 4 --output-model-dir "gs://deepfood-results-rio_janeiro_brazil" --bandit-policy explore_then_exploit --bandit-policy-params '{"explore_rounds": 1000, "decay_rate": 0.0001872157}'  
...
gcloud ai-platform jobs submit training explore_then_exploit_$(date +%Y%m%d_%H%M%S%sss) \
  ...
  --scale-tier BASIC_GPU \
  -- \
  --module recommendation.task.model.trivago.trivago_models TrivagoLogisticModelInteraction --project trivago_contextual_bandit --data-frames-preparation-extra-params '{"filter_city": "Rio de Janeiro, Brazil"}' --n-factors 50 --learning-rate=0.001 --optimizer adam --metrics '["loss"]' --epochs 250 --obs-batch-size 200 --early-stopping-patience 10 --batch-size 200 --num-episodes 4 --output-model-dir "gs://deepfood-results-rio_janeiro_brazil" --bandit-policy explore_then_exploit --bandit-policy-params '{"explore_rounds": 1000, "decay_rate": 0.000115122627531392}'  