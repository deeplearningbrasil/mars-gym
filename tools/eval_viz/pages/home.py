...
input_model_eval  = st.sidebar.selectbox("Choose your age: ", sorted(list_result_paths().keys()))
input_models_eval = st.sidebar.multiselect("Who are your favorite artists?", sorted(list_result_paths().keys()))
